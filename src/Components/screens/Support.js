        ...
        <div id="main">
            ...
            <div style={{marginTop:"90px",marginLeft:"120px"}}>
                ...
                <div className="input-group mb-3">
                    ...
                    <input type="tel" className="form-control" placeholder="Phone Number" aria-label="Username" aria-describedby="basic-addon1" />
                </div>
                ...
                <div className="input-group mb-3">
                    ...
                    <input type="datetime-local" className="form-control" aria-label="Username" aria-describedby="basic-addon1" />
                </div>
